...
import com.galigeo.fetcher.AbstractOffsetFetcher;
import com.galigeo.model.AbstractPost;
import com.galigeo.model.foursquare.place.FoursquareTrendingPlace;
 ...
 */
public class FoursquareOffSetFetcher extends AbstractOffsetFetcher{
	/*
	...
	*/
	...
	public FoursquareOffSetFetcher(String apiName){
		this.apiName = apiName;
        this.sleepAfterFetch = 10;
        this.sleepAfterCycle = 120;
        this.startLatitude  = Config.PARIS_NE.getLat(); //52.543;
        this.startLongitude = Config.PARIS_SW.getLng(); //13.280;
        this.lonStep   = 0.036;
        this.latStep   = -0.028;
        this.lonRepeat = 6;
        this.latRepeat = 4;
	...
	public List<AbstractPost> fetch(String query) {
        List<AbstractPost> results = new ArrayList<AbstractPost>();
		try{
